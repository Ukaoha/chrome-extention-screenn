...
<section className="w-full flex flex-col items-center py-12  ">
  <div className=" flex flex-col items-center gap-[0.5rem] mt-10">
    ...
    <p className=" font-workSans font-[400] text-[#616163] text-[1.25rem] leading-[1.891rem] mb-8">
      Key Highlights of Our Extension
    </p>
  </div>
  <div className="flex flex-row items-center my-4 px-[5rem] ">
    ...
    <div className="flex flex-col gap-y-[2rem]">
      <div className="flex gap-x-[1rem]">
        ...
        <div className="flex flex-col gap-y-[0.5rem]">
          ...
          <p className="font-workSans font-[400] text-[1.25rem] leading-[1.891rem] text-[#616163] max-w-[70%]">
  Effortless screen recording for everyone. Record with ease, no tech expertise required.
    ...
    <img src='./images/video.svg' alt="videoRepository image"  />
  </div>
</section>
